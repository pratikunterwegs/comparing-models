...
# save networks
save(networks_random, file = "inst/data/networks_random_patchy.Rds")
```
...
# save networks
save(networks_random, file = "inst/data/networks_random_homog.Rds")
```
...
# save networks
save(networks_optimal, file = "inst/data/networks_optimal_patchy.Rds")
```
...
# save networks
save(networks_optimal, file = "inst/data/networks_optimal_homog.Rds")
```
...
# save networks
save(networks_evolved, file = "inst/data/networks_evolved_homog.Rds")
```
