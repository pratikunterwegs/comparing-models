...
data_sir_models = Map(
  ...
  f = function(file) {
    ...
    sim_type = stringr::str_extract(file, "(evolved)|(optimal)|(random)")
    ...
    sir_data[, c("sim_type", "landscape", "dispersal") := list(
      sim_type, landscape, dispersal
    )][]
...
fwrite(
  data_sir_models,
  file = "inst/data/data_sir_thr_6.csv"
)
```
