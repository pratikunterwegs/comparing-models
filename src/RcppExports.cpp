...
// model_case_2
S4 model_case_2(const int popsize, const int nItems, const float landsize, const int nClusters, const float clusterSpread, const int tmax, const int genmax, const float range_perception, const int handling_time, const int regen_time, const int nThreads, const float max_dispersal, const float mProb, const float mSize, const bool initial_diverse);
RcppExport SEXP _ecoevomove2_model_case_2(SEXP popsizeSEXP, SEXP nItemsSEXP, SEXP landsizeSEXP, SEXP nClustersSEXP, SEXP clusterSpreadSEXP, SEXP tmaxSEXP, SEXP genmaxSEXP, SEXP range_perceptionSEXP, SEXP handling_timeSEXP, SEXP regen_timeSEXP, SEXP nThreadsSEXP, SEXP max_dispersalSEXP, SEXP mProbSEXP, SEXP mSizeSEXP, SEXP initial_diverseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const float >::type max_dispersal(max_dispersalSEXP);
    Rcpp::traits::input_parameter< const float >::type mProb(mProbSEXP);
    Rcpp::traits::input_parameter< const float >::type mSize(mSizeSEXP);
    Rcpp::traits::input_parameter< const bool >::type initial_diverse(initial_diverseSEXP);
    rcpp_result_gen = Rcpp::wrap(model_case_2(popsize, nItems, landsize, nClusters, clusterSpread, tmax, genmax, range_perception, handling_time, regen_time, nThreads, max_dispersal, mProb, mSize, initial_diverse));
    return rcpp_result_gen;
END_RCPP
}
