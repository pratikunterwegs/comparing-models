...
get_test_landscape <- function(nItems, landsize, nClusters, clusterSpread, regen_time) {
    .Call('_linkmoveecoevo_get_test_landscape', PACKAGE = 'linkmoveecoevo', nItems, landsize, nClusters, clusterSpread, regen_time)
}
...
model_case_2 <- function(scenario, popsize, nItems, landsize, nClusters, clusterSpread, tmax, genmax, range_perception, handling_time, regen_time, nThreads, dispersal, mProb, mSize) {
    .Call('_linkmoveecoevo_model_case_2', PACKAGE = 'linkmoveecoevo', scenario, popsize, nItems, landsize, nClusters, clusterSpread, tmax, genmax, range_perception, handling_time, regen_time, nThreads, dispersal, mProb, mSize)
}
